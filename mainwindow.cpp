...
//        if(!query2.exec("select RecordID from "+tablePreview+" where RecordID =(select min(RecordID) from "+tablePreview+" where UseFlag = 0)"))
//            qDebug() <<"fis 148 row "  << query2.lastError();
//        else
//        {
//            if(query2.next())
//            {
//                IDTemp = query2.value(0).toString();
//                qDebug()<<"IDTemp"<<IDTemp;

//            }
//            else
//                qDebug() << "fis is null";
//        }
//        if(!query2.exec("UPDATE "+tablePreview+" SET UseFlag = 1 WHERE RecordID = "+IDTemp))
////        if(query2.exec("UPDATE "+Localtable+" SET UploadMark = 1,UploadTime = now() WHERE RecordID = "+RecordID))
//        {
//            qDebug()<<"update UseFlag fail "<<query.lastError();
//        }
//        else
//        {
//            qDebug()<<"update UseFlag success RecordID:"<<IDTemp;
//        }
//    }
//    else
...
//                        if(query2.next())
//                        {
//                            fisVINCode = query2.value(0).toString();
//                            qDebug()<<"vinCode"<<fisVINCode;
////                            VIN_PIN_SQL = fisVINCode;
//                            emit sendFisVinCode(fisVINCode);//查fis表匹配车型
...
//                ui->prosendCmdToMaingressBar->setValue(0);
//                m_CurrentValue  = 0;
...
//flags: =1 code valide
//       =0 code invalide
//whichtmp:choose car number   轮胎机匹配工艺
/****************************/
    ...
    if(groupAllBoltNumCh > 0) //read program group and system ING
    {
        ...
        for(j = 0;j< 20;j++)
        {
            if(carInfor.boltNum[j]>0)//bolt number
            {
                ...
                QualifiedNum = 0;
                whichpdmnumnow = 0;
//                timerpdm.start(500);     //PDM bolt flick 闪个鸡毛
                break;
            }
        }
        systemStatus = 0;
...
//                    butt[0]->setStyleSheet("border-image: url(:/LCD_CS351/LCD_CS351/35_all/r01.png);font: 18pt;color:rgb(248,255,255)");
//                    butt[1]->setStyleSheet("border-image: url(:/LCD_CS351/LCD_CS351/35_all/r01.png);font: 18pt;color:rgb(248,255,255)");
//                    butt[2]->setStyleSheet("border-image: url(:/LCD_CS351/LCD_CS351/35_all/r01.png);font: 18pt;color:rgb(248,255,255)");
//                    butt[3]->setStyleSheet("border-image: url(:/LCD_CS351/LCD_CS351/35_all/r01.png);font: 18pt;color:rgb(248,255,255)");
//                    butt[4]->setStyleSheet("border-image: url(:/LCD_CS351/LCD_CS351/35_all/r01.png);font: 18pt;color:rgb(248,255,255)");
//                }
//                else
//                {
////                    butt[whichpdmnumnow]->setStyleSheet("border-image: url(:/LCD_CS351/LCD_CS351/35_all/y01.png);font: 18pt;");
//                    butt[0]->setStyleSheet("border-image: url(:/LCD_CS351/LCD_CS351/35_all/y01.png);font: 18pt;");
//                    butt[1]->setStyleSheet("border-image: url(:/LCD_CS351/LCD_CS351/35_all/y01.png);font: 18pt;");
//                    butt[2]->setStyleSheet("border-image: url(:/LCD_CS351/LCD_CS351/35_all/y01.png);font: 18pt;");
//                    butt[3]->setStyleSheet("border-image: url(:/LCD_CS351/LCD_CS351/35_all/y01.png);font: 18pt;");
//                    butt[4]->setStyleSheet("border-image: url(:/LCD_CS351/LCD_CS351/35_all/y01.png);font: 18pt;");
...
//                    butt[0]->setStyleSheet("border-image: url(:/LCD_CS351/LCD_CS351/35_all/w01.png);font: 18pt;");
//                    butt[1]->setStyleSheet("border-image: url(:/LCD_CS351/LCD_CS351/35_all/w01.png);font: 18pt;");
//                    butt[2]->setStyleSheet("border-image: url(:/LCD_CS351/LCD_CS351/35_all/w01.png);font: 18pt;");
//                    butt[3]->setStyleSheet("border-image: url(:/LCD_CS351/LCD_CS351/35_all/w01.png);font: 18pt;");
//                    butt[4]->setStyleSheet("border-image: url(:/LCD_CS351/LCD_CS351/35_all/w01.png);font: 18pt;");
//                }
//            }
//        }
//    }
...
{
    ui->label_pronum->setText("");//界面程序号显示
    ui->label_lsnum->setText("");//界面额定显示
//    if(timerpdm.isActive())
//    {
//        timerpdm.stop();//PDM图闪烁停止
//    }
...
/*******************************************/
//more channel 1,2,3,4
//ch 0,1,2,3     收到拧紧机传来的拧紧结果做相应的逻辑操作
/*******************************************/
void MainWindow::fromsecondthreaddataSB356(QString MI,QString WI,QString IsOk,int ch,int groupNum,QString proNum)
{
//    if(GCalibrationON){
//        return;
//    }
...
//        GErrorChannel.append(QString::number(ch));
        qDebug()<<"this is nok"<<proNum<<ch<<groupNum;
    }
    if(carInfor.boltNum[groupNum] > 0)
    {
        carInfor.boltNum[groupNum]--;   //结果ok 数量减1
    ...
    if(IsOk == "NOK") // 本次螺栓不合格nok
    {
        if(whichpdmnumnow < tempnumdpm)
        {
            ...
            if(GFirstTightenFlag){
                butt[whichpdmnumnow]->setStyleSheet("border-image: url(:/LCD_CS351/LCD_CS351/35_all/r01old.png);font: 18pt;color:rgb(248,255,255)");
            }else{
                butt[whichpdmnumnow]->setStyleSheet("border-image: url(:/LCD_CS351/LCD_CS351/35_all/r01.png);font: 18pt;color:rgb(248,255,255)");
            }
        }
    ...
    else//正常
    {
        if(whichpdmnumnow < tempnumdpm)
        {
            ...
            label2[whichpdmnumnow]->setStyleSheet("font: 14pt;background-color: rgb(248, 248, 248);border-width:0 1px 1px 1px; border-style:solid; border-color:rgb(25, 125, 44);");
            if(GFirstTightenFlag){
                butt[whichpdmnumnow]->setStyleSheet("border-image: url(:/LCD_CS351/LCD_CS351/35_all/g01old.png);font: 18pt;color:rgb(248,255,255)");//green button
            }else{
                butt[whichpdmnumnow]->setStyleSheet("border-image: url(:/LCD_CS351/LCD_CS351/35_all/g01.png);font: 18pt;color:rgb(248,255,255)");//green button
            }
        }
...
{
    qDebug() << "come hererer!" << isconfigone<<isPopups;
    if(SYSS == "NOK")
    {
        ConfigOneOrAll = isconfigone;//false
        if(!isconfigone)
        {
            if(!isPopups)
            {
...
void MainWindow::receiveCloseInput(bool tmp)
{
    ...
    if(tmp)
    {
        ...
        if(!ConfigOneOrAll)
        {
            emit sendTighteningResult1(3,1);//螺栓跳过
            for(int i = 0;i<5;i++){
                fromsecondthreaddataSB356("-1","-1","OK",i+1,i,"pass");
            }
        }
        else
        {
...
//        ui->label_pdmarea->setStyleSheet("font: 60pt \"黑体\";background:transparent;");
//        if("MM" == vari1)
//            ui->label_pdmarea->setText(tr("车辆完成放行"));
//        if("M" == vari1)
...
{
    qDebug()<<"handinputVIN"<<code;
//    ui->label_17->setText(code);
    emit sendPLCVIN(code);
}
...
void MainWindow::showEmergencyStop(bool isMove)
{
    ...
    //In_Output->writeIOOutput("r_led",true);
    qDebug()<<"showEmergencyStop:"<<isMove;
    if(!isMove) //急停
    {
...
//            isSaveShow = true;
    ...
    else // 急停复位后直接在原弹窗上修改提示内容为: "重新启动AGV小车？"
    {
        emit sendChangeEmergencyStop(); // "重新启动AGV小车？"
    }
}
...
//    emit sendStepResetEmergencyStop(isReset);//有点击急停提示框（目前只有确定），等待急停按钮复位
}
...
//左下角显示拧紧前后的提示结果
void MainWindow::revMesFromStep(QString mes, bool flag)
{
    if(flag)
    {
        ui->label_tishu->show();
        ui->label_tishu->setText(mes);
    }
    else
    {
        ui->label_tishu->hide();
...
//显示PLCDB块实时车码
void MainWindow::showCurrentCode(QString code)
{
    if(code.size() > 0){
        ui->label_showCode->setText(code);
    }else{
        ui->label_showCode->setText("DB模块内车码为空");
    }
}
