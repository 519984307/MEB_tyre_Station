...
public slots:
    ...
    void fromsecondthreaddataSB356(QString,QString,QString,int,int,QString);
...
//    void getSerialNum(QString,bool,QString);
    ...
    void showCurrentCode(QString);

//    void tighteningResultDisplay();
signals:
    void sendPLCVIN(QString);
    void closeThread();
//    void sendoperate();
...
//    void shutdown(int);
    ...
    void directShowHome();
    void revMesFromStep(QString,bool);
