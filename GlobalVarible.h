...
extern bool GCalibrationON;//标定开启/关闭
extern bool GFirstTightenFlag;//当前位置第一次拧紧
...
extern QString RFIDVin;
extern QString RFIDG9;
extern QString GRFIDIP;
extern int GRFIDPort;
